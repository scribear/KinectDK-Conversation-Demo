...
function App() {
  ...
  window.onload = function() {
    ...
    console.log(12, `${(context.state === 'suspended')? 'AudioContext suspended, click start to create/resume' : 'state: '}`, context.state);
    // Setup all nodes
    // ...
    ...
    document.querySelector('button')!.addEventListener('click', function() {
      context.resume().then(() => {
        console.log(26, 'Playback resumed successfully, state: ' + context.state);
